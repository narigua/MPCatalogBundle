...
class ProductController extends Controller
{
    ...
    public function indexAction(Request $request)
    {
        ...
        $entities = $em->getRepository('MPCatalogBundle:Product')->findAll();
    ...
    {
        $em = $this->getDoctrine()->getManager();
        $entity = $em->getRepository('MPCatalogBundle:Product')->find($id);
     ...
     * @Method("POST")
     * @Template("MPCatalogBundle:Product:new.html.twig")
     */
     ...
     * @Method("POST")
     * @Template("MPCatalogBundle:Product:edit.html.twig")
     */
